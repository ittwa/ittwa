...
const CHAMPIONS: { year: string; champion: string; runnerUp: string; third: string }[] = [
  { year: "2025", champion: "Tiger Clancy", runnerUp: "Mike Chapman", third: "Liam Collins" },
  { year: "2024", champion: "Liam Collins", runnerUp: "Jorge Albarran", third: "Sam Cummings" },
  { year: "2023", champion: "Tiger Clancy", runnerUp: "Sam Cummings", third: "Mike Chapman" },
  { year: "2022", champion: "Sam Cummings", runnerUp: "Tiger Clancy", third: "Brian Peterson" },
  { year: "2021", champion: "Jorge Albarran", runnerUp: "Sam Cummings", third: "Tiger Clancy" },
  { year: "2020", champion: "Mike Chapman", runnerUp: "Liam Collins", third: "Zach Katz" },
  { year: "2019", champion: "Brian Peterson", runnerUp: "Mike Chapman", third: "Jorge Albarran" },
  { year: "2018", champion: "Zach Katz", runnerUp: "Brian Peterson", third: "Liam Collins" },
  { year: "2017", champion: "Tiger Clancy", runnerUp: "Zach Katz", third: "Sam Cummings" },
  { year: "2016", champion: "Mike Durkin", runnerUp: "Mike Lamb", third: "Chris Brown" },
  { year: "2015", champion: "Ryan Bohne", runnerUp: "Tiger Clancy", third: "Jorge Albarran" },
  { year: "2014", champion: "Sam Cummings", runnerUp: "Ryan Bohne", third: "Mike Durkin" },
];

const ALL_TIME_STANDINGS: { owner: string; wins: number; losses: number; pf: number; rings: number; playoffs: number }[] = [
  { owner: "Tiger Clancy", wins: 89, losses: 67, pf: 14832, rings: 3, playoffs: 9 },
  { owner: "Sam Cummings", wins: 82, losses: 74, pf: 13940, rings: 2, playoffs: 8 },
  { owner: "Liam Collins", wins: 79, losses: 77, pf: 13580, rings: 1, playoffs: 7 },
  { owner: "Mike Chapman", wins: 76, losses: 80, pf: 13210, rings: 1, playoffs: 7 },
  { owner: "Jorge Albarran", wins: 74, losses: 82, pf: 13050, rings: 1, playoffs: 6 },
  { owner: "Brian Peterson", wins: 71, losses: 85, pf: 12870, rings: 1, playoffs: 5 },
  { owner: "Zach Katz", wins: 69, losses: 87, pf: 12640, rings: 1, playoffs: 5 },
  { owner: "Ryan Bohne", wins: 67, losses: 89, pf: 12420, rings: 1, playoffs: 4 },
  { owner: "Mike Durkin", wins: 65, losses: 91, pf: 12180, rings: 1, playoffs: 4 },
  { owner: "Mike Lamb", wins: 62, losses: 94, pf: 11950, rings: 0, playoffs: 3 },
  { owner: "Chris Brown", wins: 58, losses: 98, pf: 11620, rings: 0, playoffs: 2 },
  { owner: "Justin Williams", wins: 54, losses: 102, pf: 11340, rings: 0, playoffs: 2 },
];

const MILESTONES: { label: string; value: string; detail: string }[] = [
  { label: "Most Points (Season)", value: "1,842.3", detail: "Tiger Clancy · 2023" },
  { label: "Fewest Points (Season)", value: "987.1", detail: "Justin Williams · 2016" },
  { label: "Highest Score (Game)", value: "198.42", detail: "Sam Cummings · Wk 12, 2022" },
  { label: "Lowest Score (Game)", value: "42.10", detail: "Chris Brown · Wk 8, 2018" },
  { label: "Longest Win Streak", value: "9W", detail: "Tiger Clancy · 2023" },
  { label: "Most Trades (Season)", value: "14", detail: "Jorge Albarran · 2021" },
];
